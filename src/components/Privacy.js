  ...
  return (
    <div>
      ...
      <div className="privacy">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Paradise Cabinet.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Paradise Cabinet, accessible
              from{" "}
              <a
                href="http://www.paradisecabinet.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.paradisecabinet.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <p>By email: paradisecabinetca@gmail.com</p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>By phone number: 530 733 3667</p>
          </li>
        </ul>
      </div>
      <Footer />
